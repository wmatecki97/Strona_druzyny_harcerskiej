...
<body onload="otworz()">
	...
	<div id="container">	
		<div id="pole">
				<span style="text-align: center; color:#cc3333; font-size: 40px; "> ODKRYWCA </span>
							...
							if ($polaczenie->connect_errno!=0)
							{
								...
								$result = $polaczenie->query(sprintf("SELECT * FROM proby WHERE '%f'= id  and status = 'trwa' and realizowany_stopien='odkrywca' ", $_SESSION['id']));
									...
									{	
										...
										echo '<div class="zadanie">'.$row1->t24.'</div><div class="zadanie">'.$row->zad24.'</div><div style="clear:both"></div>';
										...
										echo '<div class="zadanie">'.$row1->t25.'</div><div class="zadanie">'.$row->zad25.'</div><div style="clear:both"></div>';
										echo '<div class="zadanie">'.$row1->t26.'</div><div class="zadanie">'.$row->zad26.'</div><div style="clear:both"></div>';
										echo '<div class="zadanie">'.$row1->t27.'</div><div class="zadanie">'.$row->zad27.'</div><div style="clear:both"></div>';
										//TUTAJ DUZO WIECEJ TEGO										
									}
									else // ROZPISUJE ZADANIA NA PROBE
									{
										$result = $polaczenie->query(sprintf("SELECT * FROM proby WHERE '%f'= id  and status = 'uwagi' and realizowany_stopien='odkrywca' ", $_SESSION['id']));
										if($result ->num_rows)//	wyswietla probe i zadania wraz z uwagami;
										{
															...
															echo '<div class="zadanie">'.$row1->t24.'</div><div class="zadanie"><input type="text" value="'.$row->zad24.'" name="input24" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div>';
															echo '<div style="text-align:center; width:880px; color:#ad8585; padding:30px;  border-top: 2px double gray;">POSZUKIWANIE PÓL SŁUŻBY:</div>';
															echo '<div class="zadanie">'.$row1->t25.'</div><div class="zadanie"><input type="text" value="'.$row->zad25.'" name="input25" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div>';
															echo '<div class="zadanie">'.$row1->t26.'</div><div class="zadanie"><input type="text" value="'.$row->zad26.'" name="input26" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div>';
															echo '<div class="zadanie">'.$row1->t27.'</div><div class="zadanie"><input type="text" value="'.$row->zad27.'" name="input27" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div>';
										...
										{
											if($result = $polaczenie->query(sprintf("SELECT * FROM proby WHERE '%f'= id  and status = 'weryfikacja' and realizowany_stopien='odkrywca' ", $_SESSION['id'])))if($result ->num_rows)echo 'WERYFIKACJA W TOKU...';
											else{
													...
													echo '<div class="zadanie">'.$row1->t1.'</div><div class="zadanie"><input type="text" name="input1" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad1 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad1.'</div>';
													echo '<div class="zadanie">'.$row1->t2.'</div><div class="zadanie"><input type="text" name="input2" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad2 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad2.'</div>';
													echo '<div class="zadanie">'.$row1->t3.'</div><div class="zadanie"><input type="text" name="input3" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad3 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad3.'</div>';
													echo '<div class="zadanie">'.$row1->t4.'</div><div class="zadanie"><input type="text" name="input4" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad4 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad4.'</div>';
													echo '<div class="zadanie">'.$row1->t5.'</div><div class="zadanie"><input type="text" name="input5" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad5 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad5.'</div>';
													echo '<div class="zadanie">'.$row1->t6.'</div><div class="zadanie"><input type="text" name="input6" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad6 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad6.'</div>';
													echo '<div class="zadanie">'.$row1->t7.'</div><div class="zadanie"><input type="text" name="input7" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad7 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad7.'</div>';
													echo '<div class="zadanie">'.$row1->t8.'</div><div class="zadanie"><input type="text" name="input8" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad8 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad8.'</div>';
													echo '<div class="zadanie">'.$row1->t9.'</div><div class="zadanie"><input type="text" name="input9" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad9 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad9.'</div>';
													echo '<div class="zadanie">'.$row1->t10.'</div><div class="zadanie"><input type="text" name="input10" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad10 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad10.'</div>';
													echo '<div class="zadanie">'.$row1->t11.'</div><div class="zadanie"><input type="text" name="input11" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad11 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad11.'</div>';
													echo '<div class="zadanie">'.$row1->t12.'</div><div class="zadanie"><input type="text" name="input12" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad12 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad12.'</div>';
													echo '<div class="zadanie">'.$row1->t13.'</div><div class="zadanie"><input type="text" name="input13" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad13 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad13.'</div>';
													echo '<div style="text-align:center; width:880px; color:#ad8585; padding:30px;  border-top: 2px double gray;">DOSKONALENIE HARCERSKIE:</div>';
													echo '<div class="zadanie">'.$row1->t14.'</div><div class="zadanie"><input type="text" name="input14" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad14 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad14.'</div>';
													echo '<div class="zadanie">'.$row1->t15.'</div><div class="zadanie"><input type="text" name="input15" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad15 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad15.'</div>';
													echo '<div class="zadanie">'.$row1->t16.'</div><div class="zadanie"><input type="text" name="input16" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad16 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad16.'</div>';
													echo '<div class="zadanie">'.$row1->t17.'</div><div class="zadanie"><input type="text" name="input17" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad17 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad17.'</div>';
													echo '<div class="zadanie">'.$row1->t18.'</div><div class="zadanie"><input type="text" name="input18" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad18 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad18.'</div>';
													echo '<div class="zadanie">'.$row1->t19.'</div><div class="zadanie"><input type="text" name="input19" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad19 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad19.'</div>';
													echo '<div class="zadanie">'.$row1->t20.'</div><div class="zadanie"><input type="text" name="input20" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad20 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad20.'</div>';
													echo '<div class="zadanie">'.$row1->t21.'</div><div class="zadanie"><input type="text" name="input21" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad21 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad21.'</div>';
													echo '<div class="zadanie">'.$row1->t22.'</div><div class="zadanie"><input type="text" name="input22" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad22 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad22.'</div>';
													echo '<div class="zadanie">'.$row1->t23.'</div><div class="zadanie"><input type="text" name="input23" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad23 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad23.'</div>';
													echo '<div class="zadanie">'.$row1->t24.'</div><div class="zadanie"><input type="text" name="input24" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad24 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad24.'</div>';
													echo '<div style="text-align:center; width:880px; color:#ad8585; padding:30px;  border-top: 2px double gray;">POSZUKIWANIE PÓL SŁUŻBY:</div>';
													echo '<div class="zadanie">'.$row1->t25.'</div><div class="zadanie"><input type="text" name="input25" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad25 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad25.'</div>';
													echo '<div class="zadanie">'.$row1->t26.'</div><div class="zadanie"><input type="text" name="input26" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad26 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad26.'</div>';
													echo '<div class="zadanie">'.$row1->t27.'</div><div class="zadanie"><input type="text" name="input27" style="width:350px; height:30px; margin-top: 50px;"/></div><div style="clear:both"></div><div style="text-align:center; width:880px; color:#b9ccb3; padding:30px;  border-top: 2px double gray;">';
														$result = $polaczenie->query(sprintf("SELECT zad27 FROM proby WHERE  (status='ukonczono' or status = 'trwa') and realizowany_stopien='odkrywca' ORDER BY RAND() LIMIT 1"));$row = $result ->fetch_object(); echo 'PRZYKŁAD:</br></br>'.$row->zad27.'</div>';
